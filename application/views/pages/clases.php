                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <i class="glyphicon glyphicon-plus"></i> Agregar Clase
                            </button>
                        </div>
                        <div class="col-sm-6 text-right">
                            ...
                            <div class="table-responsive col-sm-12">
                                ...
                                anchor("clientes/modificar", '<i class="glyphicon glyphicon-pencil"><span class="hidden-xs"> Modificar</span></i>', array('class' => 'btn btn-info btn-sm max', "role" => "button")) . " " .
                                anchor("clientes/eliminar", '<i class="glyphicon glyphicon-trash"><span class="hidden-xs"> Borrar</span></i>', array('onclick'=>"return confirm('¿Está seguro que desea eliminar X?')", 'class' => 'btn btn-danger btn-sm max', "role" => "button"))
                                ));
                                }
